...
namespace csce438 {
class ListPorts;
struct ListPortsDefaultTypeInternal;
extern ListPortsDefaultTypeInternal _ListPorts_default_instance_;
class ListReply;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::csce438::ListPorts* Arena::CreateMaybeMessage<::csce438::ListPorts>(Arena*);
...
template<> ::csce438::Update* Arena::CreateMaybeMessage<::csce438::Update>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace csce438 {
...
class Update final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:csce438.Update) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:csce438.Update)
 private:
  class _Internal;
...
class ListPorts final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:csce438.ListPorts) */ {
 public:
  inline ListPorts() : ListPorts(nullptr) {}
  ~ListPorts() override;
  explicit constexpr ListPorts(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ListPorts(const ListPorts& from);
  ListPorts(ListPorts&& from) noexcept
    : ListPorts() {
    *this = ::std::move(from);
  }

  inline ListPorts& operator=(const ListPorts& from) {
    CopyFrom(from);
    return *this;
  }
  inline ListPorts& operator=(ListPorts&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ListPorts& default_instance() {
    return *internal_default_instance();
  }
  static inline const ListPorts* internal_default_instance() {
    return reinterpret_cast<const ListPorts*>(
               &_ListPorts_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(ListPorts& a, ListPorts& b) {
    a.Swap(&b);
  }
  inline void Swap(ListPorts* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(ListPorts* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline ListPorts* New() const final {
    return new ListPorts();
  }

  ListPorts* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ListPorts>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ListPorts& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const ListPorts& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ListPorts* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "csce438.ListPorts";
  }
  protected:
  explicit ListPorts(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // @@protoc_insertion_point(class_scope:csce438.ListPorts)
 private:
  class _Internal;
...
// string username = 1;
inline void Update::clear_username() {
  username_.ClearToEmpty();
}
inline const std::string& Update::username() const {
  // @@protoc_insertion_point(field_get:csce438.Update.username)
  return _internal_username();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Update::set_username(ArgT0&& arg0, ArgT... args) {
 
 username_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:csce438.Update.username)
}
inline std::string* Update::mutable_username() {
  std::string* _s = _internal_mutable_username();
  // @@protoc_insertion_point(field_mutable:csce438.Update.username)
  return _s;
}
inline const std::string& Update::_internal_username() const {
  return username_.Get();
}
inline void Update::_internal_set_username(const std::string& value) {
  
  username_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Update::_internal_mutable_username() {
  
  return username_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Update::release_username() {
  // @@protoc_insertion_point(field_release:csce438.Update.username)
  return username_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Update::set_allocated_username(std::string* username) {
  if (username != nullptr) {
  ...
  username_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), username,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:csce438.Update.username)
}

// string msg = 2;
inline void Update::clear_msg() {
  msg_.ClearToEmpty();
}
inline const std::string& Update::msg() const {
  // @@protoc_insertion_point(field_get:csce438.Update.msg)
  return _internal_msg();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Update::set_msg(ArgT0&& arg0, ArgT... args) {
 
 msg_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:csce438.Update.msg)
}
inline std::string* Update::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:csce438.Update.msg)
  return _s;
}
inline const std::string& Update::_internal_msg() const {
  return msg_.Get();
}
inline void Update::_internal_set_msg(const std::string& value) {
  
  msg_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Update::_internal_mutable_msg() {
  
  return msg_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Update::release_msg() {
  // @@protoc_insertion_point(field_release:csce438.Update.msg)
  return msg_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Update::set_allocated_msg(std::string* msg) {
  if (msg != nullptr) {
  ...
  msg_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), msg,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:csce438.Update.msg)
}
...
inline const std::string& Update::type() const {
  // @@protoc_insertion_point(field_get:csce438.Update.type)
  return _internal_type();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Update::set_type(ArgT0&& arg0, ArgT... args) {
 
 type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:csce438.Update.type)
}
inline std::string* Update::mutable_type() {
  std::string* _s = _internal_mutable_type();
  // @@protoc_insertion_point(field_mutable:csce438.Update.type)
  return _s;
}
inline const std::string& Update::_internal_type() const {
  return type_.Get();
}
inline void Update::_internal_set_type(const std::string& value) {
  
  type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Update::_internal_mutable_type() {
  
  return type_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Update::release_type() {
  // @@protoc_insertion_point(field_release:csce438.Update.type)
...
inline void Update::set_allocated_type(std::string* type) {
  ...
  type_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), type,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:csce438.Update.type)
}
...
// repeated string ports = 1;
inline int ListPorts::_internal_ports_size() const {
  return ports_.size();
}
inline int ListPorts::ports_size() const {
  return _internal_ports_size();
}
inline void ListPorts::clear_ports() {
  ports_.Clear();
}
inline std::string* ListPorts::add_ports() {
  std::string* _s = _internal_add_ports();
  // @@protoc_insertion_point(field_add_mutable:csce438.ListPorts.ports)
  return _s;
}
inline const std::string& ListPorts::_internal_ports(int index) const {
  return ports_.Get(index);
}
inline const std::string& ListPorts::ports(int index) const {
  // @@protoc_insertion_point(field_get:csce438.ListPorts.ports)
  return _internal_ports(index);
}
inline std::string* ListPorts::mutable_ports(int index) {
  // @@protoc_insertion_point(field_mutable:csce438.ListPorts.ports)
  return ports_.Mutable(index);
}
inline void ListPorts::set_ports(int index, const std::string& value) {
  ports_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:csce438.ListPorts.ports)
}
inline void ListPorts::set_ports(int index, std::string&& value) {
  ports_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:csce438.ListPorts.ports)
}
inline void ListPorts::set_ports(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  ports_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:csce438.ListPorts.ports)
}
inline void ListPorts::set_ports(int index, const char* value, size_t size) {
  ports_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:csce438.ListPorts.ports)
}
inline std::string* ListPorts::_internal_add_ports() {
  return ports_.Add();
}
inline void ListPorts::add_ports(const std::string& value) {
  ports_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:csce438.ListPorts.ports)
}
inline void ListPorts::add_ports(std::string&& value) {
  ports_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:csce438.ListPorts.ports)
}
inline void ListPorts::add_ports(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  ports_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:csce438.ListPorts.ports)
}
inline void ListPorts::add_ports(const char* value, size_t size) {
  ports_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:csce438.ListPorts.ports)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
ListPorts::ports() const {
  // @@protoc_insertion_point(field_list:csce438.ListPorts.ports)
  return ports_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
ListPorts::mutable_ports() {
  // @@protoc_insertion_point(field_mutable_list:csce438.ListPorts.ports)
  return &ports_;
}
