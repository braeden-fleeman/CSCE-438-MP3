...
static const char* SNSService_method_names[] = {
  ...
  "/csce438.SNSService/ServerUpdate",
};
...
SNSService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_ServerUpdate_(SNSService_method_names[5], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status SNSService::Stub::ServerUpdate(::grpc::ClientContext* context, const ::csce438::Update& request, ::csce438::Reply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::csce438::Update, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_ServerUpdate_, context, request, response);
}

void SNSService::Stub::async::ServerUpdate(::grpc::ClientContext* context, const ::csce438::Update* request, ::csce438::Reply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::csce438::Update, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_ServerUpdate_, context, request, response, std::move(f));
}

void SNSService::Stub::async::ServerUpdate(::grpc::ClientContext* context, const ::csce438::Update* request, ::csce438::Reply* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_ServerUpdate_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* SNSService::Stub::PrepareAsyncServerUpdateRaw(::grpc::ClientContext* context, const ::csce438::Update& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::csce438::Reply, ::csce438::Update, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_ServerUpdate_, context, request);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* SNSService::Stub::AsyncServerUpdateRaw(::grpc::ClientContext* context, const ::csce438::Update& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncServerUpdateRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
SNSService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SNSService::Service, ::csce438::Update, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SNSService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::csce438::Update* req,
             ::csce438::Reply* resp) {
               return service->ServerUpdate(ctx, req, resp);
             }, this)));
}
...
::grpc::Status SNSService::Service::ServerUpdate(::grpc::ServerContext* context, const ::csce438::Update* request, ::csce438::Reply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
static const char* Coordinator_Service_method_names[] = {
  ...
  "/csce438.Coordinator_Service/HandleSynchronizer",
  "/csce438.Coordinator_Service/GetAllSynchronizers",
};
...
Coordinator_Service::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_HandleSynchronizer_(Coordinator_Service_method_names[3], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetAllSynchronizers_(Coordinator_Service_method_names[4], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status Coordinator_Service::Stub::HandleClient(::grpc::ClientContext* context, const ::csce438::Request& request, ::csce438::Reply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::csce438::Request, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_HandleClient_, context, request, response);
}

void Coordinator_Service::Stub::async::HandleClient(::grpc::ClientContext* context, const ::csce438::Request* request, ::csce438::Reply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::csce438::Request, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_HandleClient_, context, request, response, std::move(f));
}

void Coordinator_Service::Stub::async::HandleClient(::grpc::ClientContext* context, const ::csce438::Request* request, ::csce438::Reply* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_HandleClient_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* Coordinator_Service::Stub::PrepareAsyncHandleClientRaw(::grpc::ClientContext* context, const ::csce438::Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::csce438::Reply, ::csce438::Request, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_HandleClient_, context, request);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* Coordinator_Service::Stub::AsyncHandleClientRaw(::grpc::ClientContext* context, const ::csce438::Request& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncHandleClientRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
::grpc::Status Coordinator_Service::Stub::HandleSynchronizer(::grpc::ClientContext* context, const ::csce438::Request& request, ::csce438::Reply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::csce438::Request, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_HandleSynchronizer_, context, request, response);
}

void Coordinator_Service::Stub::async::HandleSynchronizer(::grpc::ClientContext* context, const ::csce438::Request* request, ::csce438::Reply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::csce438::Request, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_HandleSynchronizer_, context, request, response, std::move(f));
}

void Coordinator_Service::Stub::async::HandleSynchronizer(::grpc::ClientContext* context, const ::csce438::Request* request, ::csce438::Reply* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_HandleSynchronizer_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* Coordinator_Service::Stub::PrepareAsyncHandleSynchronizerRaw(::grpc::ClientContext* context, const ::csce438::Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::csce438::Reply, ::csce438::Request, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_HandleSynchronizer_, context, request);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* Coordinator_Service::Stub::AsyncHandleSynchronizerRaw(::grpc::ClientContext* context, const ::csce438::Request& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncHandleSynchronizerRaw(context, request, cq);
  result->StartCall();
  return result;
}

::grpc::Status Coordinator_Service::Stub::GetAllSynchronizers(::grpc::ClientContext* context, const ::csce438::Request& request, ::csce438::ListPorts* response) {
  return ::grpc::internal::BlockingUnaryCall< ::csce438::Request, ::csce438::ListPorts, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetAllSynchronizers_, context, request, response);
}

void Coordinator_Service::Stub::async::GetAllSynchronizers(::grpc::ClientContext* context, const ::csce438::Request* request, ::csce438::ListPorts* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::csce438::Request, ::csce438::ListPorts, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetAllSynchronizers_, context, request, response, std::move(f));
}

void Coordinator_Service::Stub::async::GetAllSynchronizers(::grpc::ClientContext* context, const ::csce438::Request* request, ::csce438::ListPorts* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetAllSynchronizers_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::csce438::ListPorts>* Coordinator_Service::Stub::PrepareAsyncGetAllSynchronizersRaw(::grpc::ClientContext* context, const ::csce438::Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::csce438::ListPorts, ::csce438::Request, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetAllSynchronizers_, context, request);
}

::grpc::ClientAsyncResponseReader< ::csce438::ListPorts>* Coordinator_Service::Stub::AsyncGetAllSynchronizersRaw(::grpc::ClientContext* context, const ::csce438::Request& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncGetAllSynchronizersRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
Coordinator_Service::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      Coordinator_Service_method_names[1],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      Coordinator_Service_method_names[3],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Coordinator_Service::Service, ::csce438::Request, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Coordinator_Service::Service* service,
             ::grpc::ServerContext* ctx,
             const ::csce438::Request* req,
             ::csce438::Reply* resp) {
               return service->HandleSynchronizer(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      Coordinator_Service_method_names[4],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Coordinator_Service::Service, ::csce438::Request, ::csce438::ListPorts, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Coordinator_Service::Service* service,
             ::grpc::ServerContext* ctx,
             const ::csce438::Request* req,
             ::csce438::ListPorts* resp) {
               return service->GetAllSynchronizers(ctx, req, resp);
             }, this)));
}
...
::grpc::Status Coordinator_Service::Service::HandleSynchronizer(::grpc::ServerContext* context, const ::csce438::Request* request, ::csce438::Reply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status Coordinator_Service::Service::GetAllSynchronizers(::grpc::ServerContext* context, const ::csce438::Request* request, ::csce438::ListPorts* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
static const char* Synchronizer_Service_method_names[] = {
  "/csce438.Synchronizer_Service/SyncUpdate",
};

std::unique_ptr< Synchronizer_Service::Stub> Synchronizer_Service::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< Synchronizer_Service::Stub> stub(new Synchronizer_Service::Stub(channel, options));
  return stub;
}

Synchronizer_Service::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_SyncUpdate_(Synchronizer_Service_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}

::grpc::Status Synchronizer_Service::Stub::SyncUpdate(::grpc::ClientContext* context, const ::csce438::Update& request, ::csce438::Reply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::csce438::Update, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_SyncUpdate_, context, request, response);
}

void Synchronizer_Service::Stub::async::SyncUpdate(::grpc::ClientContext* context, const ::csce438::Update* request, ::csce438::Reply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::csce438::Update, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SyncUpdate_, context, request, response, std::move(f));
}

void Synchronizer_Service::Stub::async::SyncUpdate(::grpc::ClientContext* context, const ::csce438::Update* request, ::csce438::Reply* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SyncUpdate_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* Synchronizer_Service::Stub::PrepareAsyncSyncUpdateRaw(::grpc::ClientContext* context, const ::csce438::Update& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::csce438::Reply, ::csce438::Update, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_SyncUpdate_, context, request);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* Synchronizer_Service::Stub::AsyncSyncUpdateRaw(::grpc::ClientContext* context, const ::csce438::Update& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncSyncUpdateRaw(context, request, cq);
  result->StartCall();
  return result;
}

Synchronizer_Service::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      Synchronizer_Service_method_names[0],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Synchronizer_Service::Service, ::csce438::Update, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Synchronizer_Service::Service* service,
             ::grpc::ServerContext* ctx,
             const ::csce438::Update* req,
             ::csce438::Reply* resp) {
               return service->SyncUpdate(ctx, req, resp);
             }, this)));
}
...
::grpc::Status Synchronizer_Service::Service::SyncUpdate(::grpc::ServerContext* context, const ::csce438::Update* request, ::csce438::Reply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
