...
constexpr ListPorts::ListPorts(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : ports_(){}
struct ListPortsDefaultTypeInternal {
  constexpr ListPortsDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~ListPortsDefaultTypeInternal() {}
  union {
    ListPorts _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ListPortsDefaultTypeInternal _ListPorts_default_instance_;
}  // namespace csce438
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_sns_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::csce438::Update, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::csce438::Update, username_),
  PROTOBUF_FIELD_OFFSET(::csce438::Update, msg_),
  PROTOBUF_FIELD_OFFSET(::csce438::Update, type_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::csce438::ListPorts, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::csce438::ListPorts, ports_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 32, -1, -1, sizeof(::csce438::Update)},
  { 41, -1, -1, sizeof(::csce438::ListPorts)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::csce438::_Update_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::csce438::_ListPorts_default_instance_),
};
...
const char descriptor_table_protodef_sns_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\n\tListPorts\022\r\n\005ports\030\001 \003(\t2\256\002\n\nSNSServic"
  ...
  "0\001\022/\n\014ServerUpdate\022\017.csce438.Update\032\016.cs"
  "ce438.Reply2\246\002\n\023Coordinator_Service\022/\n\tH"
  "eartBeat\022\020.csce438.Message\032\016.csce438.Rep"
  "ly\"\000\0222\n\014HandleClient\022\020.csce438.Request\032\016"
  ".csce438.Reply\"\000\0221\n\013HandleSlave\022\020.csce43"
  "8.Request\032\016.csce438.Reply\"\000\0228\n\022HandleSyn"
  "chronizer\022\020.csce438.Request\032\016.csce438.Re"
  "ply\"\000\022=\n\023GetAllSynchronizers\022\020.csce438.R"
  "equest\032\022.csce438.ListPorts\"\0002G\n\024Synchron"
  "izer_Service\022/\n\nSyncUpdate\022\017.csce438.Upd"
  "ate\032\016.csce438.Reply\"\000b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_sns_2eproto = {
  false, false, 1029, descriptor_table_protodef_sns_2eproto, "sns.proto", 
...
Update::Update(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:csce438.Update)
}
Update::Update(const Update& from)
  ...
  // @@protoc_insertion_point(copy_constructor:csce438.Update)
}
...
Update::~Update() {
  // @@protoc_insertion_point(destructor:csce438.Update)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
void Update::Clear() {
// @@protoc_insertion_point(message_clear_start:csce438.Update)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          auto str = _internal_mutable_username();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "csce438.Update.username"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          auto str = _internal_mutable_msg();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "csce438.Update.msg"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "csce438.Update.type"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Update::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:csce438.Update)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:csce438.Update)
  return target;
}

size_t Update::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:csce438.Update)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:csce438.Update)
  GOOGLE_DCHECK_NE(&from, this);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:csce438.Update)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class ListPorts::_Internal {
 public:
};

ListPorts::ListPorts(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned),
  ports_(arena) {
  SharedCtor();
  ...
  // @@protoc_insertion_point(arena_constructor:csce438.ListPorts)
}
ListPorts::ListPorts(const ListPorts& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      ports_(from.ports_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:csce438.ListPorts)
}

void ListPorts::SharedCtor() {
}

ListPorts::~ListPorts() {
  // @@protoc_insertion_point(destructor:csce438.ListPorts)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void ListPorts::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void ListPorts::ArenaDtor(void* object) {
  ListPorts* _this = reinterpret_cast< ListPorts* >(object);
  (void)_this;
}
void ListPorts::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void ListPorts::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void ListPorts::Clear() {
// @@protoc_insertion_point(message_clear_start:csce438.ListPorts)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ListPorts::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          do {
            ...
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "csce438.ListPorts.ports"));
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<10>(ptr));
        } else
...
::PROTOBUF_NAMESPACE_ID::uint8* ListPorts::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:csce438.ListPorts)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:csce438.ListPorts)
  return target;
}

size_t ListPorts::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:csce438.ListPorts)
  size_t total_size = 0;
  ...
  // repeated string ports = 1;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(ports_.size());
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ListPorts::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    ListPorts::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ListPorts::GetClassData() const { return &_class_data_; }

void ListPorts::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<ListPorts *>(to)->MergeFrom(
      static_cast<const ListPorts &>(from));
}


void ListPorts::MergeFrom(const ListPorts& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:csce438.ListPorts)
  GOOGLE_DCHECK_NE(&from, this);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void ListPorts::CopyFrom(const ListPorts& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:csce438.ListPorts)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ListPorts::IsInitialized() const {
  return true;
}

void ListPorts::InternalSwap(ListPorts* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ports_.InternalSwap(&other->ports_);
}

::PROTOBUF_NAMESPACE_ID::Metadata ListPorts::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_sns_2eproto_getter, &descriptor_table_sns_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::csce438::Update* Arena::CreateMaybeMessage< ::csce438::Update >(Arena* arena) {
  return Arena::CreateMessageInternal< ::csce438::Update >(arena);
}
template<> PROTOBUF_NOINLINE ::csce438::ListPorts* Arena::CreateMaybeMessage< ::csce438::ListPorts >(Arena* arena) {
  return Arena::CreateMessageInternal< ::csce438::ListPorts >(arena);
}
